...
void setup()
{
  ...
  capture_interval = 100; // 200 milli-secconds per frame
  total_frames = 90000;     // 9000 frames x 200 ms = 1800 sec = 30 min
...
bool init_wifi()
{
  ...
  IPAddress secondaryDNS(114, 114, 114, 114); // optional
